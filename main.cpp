...
int main()
{
	...
	srand(start.tv_usec);
	//termo parameters
	const int N_waiting_trajectories=1; //number of Metropolis steps to termolise the system
	const int N_sample_trajectories=0;//this many traj-s are used to build histogram

...
int main()
{
	...
	srand(start.tv_usec);
	//termo parameters
	const int N_waiting_trajectories=40; //number of Metropolis steps to termolise the system
	const int N_sample_trajectories=1;//this many traj-s are used to build histogram
	const int N_steps_per_traj=6000;//this many metropolis propositions are made for each of this traj-s

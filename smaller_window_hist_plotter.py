...
ift_ydata=ifft(y_data[512-256:512+256])
ift_xdata=np.linspace(-1,1,NFFT,endpoint=False)[512-256:512+256]
len=len(ift_xdata)
ax2.plot(ift_xdata[len//2-60:len//2+60],np.abs(fftshift(ift_ydata)[len//2-60:len//2+60]))
